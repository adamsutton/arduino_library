 ...
 * ***************************************************************************
 *
 * Some clock / time routines
 *
 * ***************************************************************************/

#ifndef APS_ARDUINO_UTIL_CLOCK_H
#define APS_ARDUINO_UTIL_CLOCK_H
 ...
 */
uint32_t mono_millis ( void );

/*
 * Monotonic microseconds
 */
uint32_t mono_micros ( void );

/*
 * Wait in milliseconds
 */
void     wait_millis ( uint32_t ms );
...
#endif /* APS_ARDUINO_UTIL_CLOCK_H */
